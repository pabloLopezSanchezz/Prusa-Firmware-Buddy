...
#define EEPROM_FEATURES (EEPROM_FEATURE_PID_NOZ | EEPROM_FEATURE_PID_BED | EEPROM_FEATURE_LAN | EEPROM_FEATURE_LOADCELL)
...
#define EEPROM_FEATURE_LAN     0x0004
    ...
    #define EEPROM_FEATURE_LOADCELL 0x0005
#else
    #define EEPROM_FEATURE_LOADCELL 0x0
#endif
